...
- generic [ref=e1]:
  ...
  - menu [active] [ref=e1162]:
    - generic [ref=e1164]:
      - generic [ref=e1165]:
        - generic [ref=e1168]:
          - img [ref=e1171]
          - textbox "Search" [ref=e1173]
        - combobox "State" [ref=e1176]:
          - generic [ref=e1179] [cursor=pointer]: State
      - generic [ref=e1181]:
        - generic [ref=e1183]:
          - generic [ref=e1184] [cursor=pointer]:
            - checkbox "All (35)" [checked=mixed] [ref=e1185] [cursor=pointer]
            - generic:
              - img
          - generic [ref=e1186] [cursor=pointer]: All (35)
        - generic [ref=e1187]: 7 Items Selected
      - generic [ref=e1190]:
        - generic [ref=e1192] [cursor=pointer]:
          - generic [ref=e1193] [cursor=pointer]:
            - generic [ref=e1196] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1199] [cursor=pointer]: 428 Healthcare (1)
        ...
        - generic [ref=e1206] [cursor=pointer]:
          - generic [ref=e1207] [cursor=pointer]:
            - generic [ref=e1210] [cursor=pointer]:
              - checkbox [checked] [ref=e1211] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1213] [cursor=pointer]: Advanced Health (1)
        ...
        - generic [ref=e1220] [cursor=pointer]:
          - generic [ref=e1221] [cursor=pointer]:
            - generic [ref=e1224] [cursor=pointer]:
              - checkbox [checked] [ref=e1225] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1227] [cursor=pointer]: Benchmark (1)
        ...
        - generic [ref=e1234] [cursor=pointer]:
          - generic [ref=e1235] [cursor=pointer]:
            - generic [ref=e1238] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1241] [cursor=pointer]: Citadel (1)
        ...
        - generic [ref=e1248] [cursor=pointer]:
          - generic [ref=e1249] [cursor=pointer]:
            - generic [ref=e1252] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1255] [cursor=pointer]: ClearView (1)
        ...
        - generic [ref=e1262] [cursor=pointer]:
          - generic [ref=e1263] [cursor=pointer]:
            - generic [ref=e1266] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1269] [cursor=pointer]: Ivy Healthcare (1)
        ...
        - generic [ref=e1276] [cursor=pointer]:
          - generic [ref=e1277] [cursor=pointer]:
            - generic [ref=e1280] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1283] [cursor=pointer]: Lilac (1)
        ...
        - generic [ref=e1290] [cursor=pointer]:
          - generic [ref=e1291] [cursor=pointer]:
            - generic [ref=e1294] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1297] [cursor=pointer]: Millennial (2)
        ...
        - generic [ref=e1304] [cursor=pointer]:
          - generic [ref=e1305] [cursor=pointer]:
            - generic [ref=e1308] [cursor=pointer]:
              - checkbox [checked=mixed] [ref=e1309] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1311] [cursor=pointer]: Prestige (2)
        ...
        - generic [ref=e1318] [cursor=pointer]:
          - generic [ref=e1319] [cursor=pointer]:
            - generic [ref=e1322] [cursor=pointer]:
              - checkbox [checked] [ref=e1323] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1325] [cursor=pointer]: Quantum (1)
        ...
        - generic [ref=e1332] [cursor=pointer]:
          - generic [ref=e1333] [cursor=pointer]:
            - generic [ref=e1336] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1339] [cursor=pointer]: Vintage NY (1)
        ...
        - generic [ref=e1346] [cursor=pointer]:
          - generic [ref=e1347] [cursor=pointer]:
            - generic [ref=e1350] [cursor=pointer]:
              - checkbox [checked=mixed] [ref=e1351] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1353] [cursor=pointer]: Workday Project (1)
          - button [ref=e1354] [cursor=pointer]:
            - img [ref=e1357] [cursor=pointer]
      - generic [ref=e1360]:
        - button "Clear Selection" [ref=e1362] [cursor=pointer]:
          - generic [ref=e1363] [cursor=pointer]: Clear Selection
        - button "Apply" [ref=e1365] [cursor=pointer]:
          - generic [ref=e1366] [cursor=pointer]: Apply
```