  ...
  - generic:
    - menu [ref=e1162]:
      - generic [ref=e1164]:
        ...
        - generic [ref=e1173]:
          - generic [ref=e1174]:
            - combobox "Resident" [ref=e1177]:
              - generic [ref=e1183] [cursor=pointer]: Resident
            - button "Select Resident" [expanded] [ref=e1188] [cursor=pointer]:
              - generic [ref=e1189] [cursor=pointer]: Select Resident
              - img [ref=e1193] [cursor=pointer]
          - button [ref=e1196] [cursor=pointer]:
            - img [ref=e1200] [cursor=pointer]
        - generic [ref=e1202]:
          - button "Add Filter" [disabled] [ref=e1204]:
            - generic [ref=e1205]:
              - img [ref=e1208]
              - text: Add Filter
          - button "Apply Filter" [disabled] [ref=e1211]:
            - generic [ref=e1212]: Apply Filter
    - menu [ref=e1215]:
      - generic [ref=e1217]:
        - generic [ref=e1221]:
          - img [ref=e1224]
          - textbox "Search" [active] [ref=e1226]
        - generic [ref=e1229]:
          - generic [ref=e1230] [cursor=pointer]:
            - checkbox "All (29352)" [ref=e1231] [cursor=pointer]
            - generic:
              - img
          - generic [ref=e1232] [cursor=pointer]: All (29352)
        - generic [ref=e1235]:
