  ...
  - generic:
    - menu [ref=e967]:
      - generic [ref=e969]:
        ...
        - generic [ref=e978]:
          - generic [ref=e979]:
            - combobox "Task Status" [ref=e982]:
              - generic [ref=e988] [cursor=pointer]: Task Status
            - button "Select Task Status" [expanded] [active] [ref=e993] [cursor=pointer]:
              - generic [ref=e994] [cursor=pointer]: Select Task Status
              - img [ref=e998] [cursor=pointer]
          - button [ref=e1001] [cursor=pointer]:
            - img [ref=e1005] [cursor=pointer]
        - generic [ref=e1007]:
          - button "Add Filter" [disabled] [ref=e1009]:
            - generic [ref=e1010]:
              - img [ref=e1013]
              - text: Add Filter
          - button "Apply Filter" [disabled] [ref=e1016]:
            - generic [ref=e1017]: Apply Filter
    - menu [ref=e1020]:
      - generic [ref=e1022]:
        - generic [ref=e1025]:
