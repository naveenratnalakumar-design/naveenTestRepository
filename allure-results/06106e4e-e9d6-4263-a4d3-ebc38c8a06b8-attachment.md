...
- generic [ref=e1]:
        ...
        - generic [ref=e120]:
          ...
          - generic [ref=e181]:
            - generic [ref=e183]:
              ...
              - generic [ref=e207]:
                - img [ref=e210]
                - generic [ref=e212]: Follow-Up Needed
              - generic [ref=e216]: 11/18/2025
  ...
  - generic [ref=e1165]: Jira Service Management Widget
  - iframe [ref=e1166]:
  ...
  - generic:
    - menu [ref=e1170]:
      - generic [ref=e1172]:
        - generic [ref=e1173]:
          - generic [ref=e1174]: Filter by
          - button "Clear Filter" [disabled] [ref=e1176]:
            - generic [ref=e1177]: Clear Filter
        - generic [ref=e1181]:
          - generic [ref=e1182]:
            - combobox "Task Status" [ref=e1185]:
              - generic [ref=e1191] [cursor=pointer]: Task Status
            - button "Select Task Status" [expanded] [active] [ref=e1196] [cursor=pointer]:
              - generic [ref=e1197] [cursor=pointer]: Select Task Status
              - img [ref=e1201] [cursor=pointer]
          - button [ref=e1204] [cursor=pointer]:
            - img [ref=e1208] [cursor=pointer]
        - generic [ref=e1210]:
          - button "Add Filter" [disabled] [ref=e1212]:
            - generic [ref=e1213]:
              - img [ref=e1216]
              - text: Add Filter
          - button "Apply Filter" [disabled] [ref=e1219]:
            - generic [ref=e1220]: Apply Filter
    - menu [ref=e1223]:
      - generic [ref=e1225]:
        - generic [ref=e1228]:
          - generic [ref=e1230] [cursor=pointer]:
            - generic [ref=e1233] [cursor=pointer]:
              ...
              - generic:
                - img
            - generic [ref=e1237] [cursor=pointer]: Not Started
          - generic [ref=e1239] [cursor=pointer]:
            - generic [ref=e1242] [cursor=pointer]:
              - checkbox [ref=e1243] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1246] [cursor=pointer]: In Progress
          - generic [ref=e1248] [cursor=pointer]:
            - generic [ref=e1251] [cursor=pointer]:
              - checkbox [ref=e1252] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1255] [cursor=pointer]: Completed
          - generic [ref=e1257] [cursor=pointer]:
            - generic [ref=e1260] [cursor=pointer]:
              - checkbox [ref=e1261] [cursor=pointer]
              - generic:
                - img
            - generic [ref=e1264] [cursor=pointer]: Canceled
        - generic [ref=e1266]:
          - button "Clear Selection" [disabled] [ref=e1268]:
            - generic [ref=e1269]: Clear Selection
          - button "Apply" [disabled] [ref=e1271]:
            - generic [ref=e1272]: Apply
```